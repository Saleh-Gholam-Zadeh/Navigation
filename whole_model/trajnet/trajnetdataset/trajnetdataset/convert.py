...
def orca_crowdnav(sc, input_file):
    print('processing ' + input_file)
    return (sc
            .textFile(input_file)
            .map(readers.orca_crowdnav)
            .cache())
...
def main():
    ...
    write(orca_crowdnav(sc, 'data/raw/saleh_dataset/orca_crowdNav.txt'),
          'output_pre/{split}/orca_crowdNav.ndjson')
    categorize(sc, 'output_pre/{split}/orca_crowdNav.ndjson')
