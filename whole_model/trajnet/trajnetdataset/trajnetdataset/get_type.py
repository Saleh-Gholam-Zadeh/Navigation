...
def get_type(scene):
    ...
    linear_threshold = 0.3   #  پارامتر مربوط به کالمن فیلتره که تشخیص میده تراجکتوری خطی عه یا نه اولش یک بود پارت توصیه کرد بکنمش 0.3
...
def trajectory_type(rows, path, fps, track_id=0):
    ...
    for index, scene in enumerate(scenes):
        ...
        accept = [0.1, 0.2, 1.0, 1.0]  # دومیش برای linear  عه  باید بشه حدود 0.2 یا 0.1
